...
WebUI.setText(findTestObject('Failed Login - with wrong password/valid_username'), valid_username)

WebUI.setText(findTestObject('Failed Login - with wrong password/invalid_password'), invalid_password)
